...
class TestFeedsGetFeedStatusResponseIngestionErrorsIngestionError(unittest.TestCase):
    """FeedsGetFeedStatusResponseIngestionErrorsIngestionError unit test stubs"""
    pass
