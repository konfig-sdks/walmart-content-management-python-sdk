...
class TestPartnerFeedResponseItemDetailsItemIngestionStatusItem(unittest.TestCase):
    """PartnerFeedResponseItemDetailsItemIngestionStatusItem unit test stubs"""
    pass
