...
from walmart_content_management_python_sdk.exceptions_base import ApiValueError
from walmart_content_management_python_sdk.exceptions import ClientConfigurationError
from walmart_content_management_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = walmart_content_management_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        self.api_key = {}
        if client_id:
            self.api_key['clientId'] = client_id
        else:
            raise ClientConfigurationError('API Key "clientId" is required')
        if private_key:
            self.api_key['privateKey'] = private_key
        else:
            raise ClientConfigurationError('API Key "privateKey" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("walmart_content_management_python_sdk")
