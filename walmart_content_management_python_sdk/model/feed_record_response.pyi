...
class FeedRecordResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def errors() -> typing.Type['FeedRecordResponseErrors']:
                return FeedRecordResponseErrors
            totalResults = schemas.Int64Schema
            offset = schemas.Int64Schema
            limit = schemas.Int32Schema
        
            @staticmethod
            def results() -> typing.Type['FeedRecordResponseResults']:
                return FeedRecordResponseResults
            __annotations__ = {
                "errors": errors,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["errors"]) -> 'FeedRecordResponseErrors': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["results"]) -> 'FeedRecordResponseResults': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["errors"]) -> typing.Union['FeedRecordResponseErrors', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["results"]) -> typing.Union['FeedRecordResponseResults', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        errors: typing.Union['FeedRecordResponseErrors', schemas.Unset] = schemas.unset,
        ...
        results: typing.Union['FeedRecordResponseResults', schemas.Unset] = schemas.unset,
