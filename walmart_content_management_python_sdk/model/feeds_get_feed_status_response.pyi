...
class FeedsGetFeedStatusResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def errors() -> typing.Type['FeedsGetFeedStatusResponseErrors']:
                return FeedsGetFeedStatusResponseErrors
            ...
            @staticmethod
            def ingestionErrors() -> typing.Type['FeedsGetFeedStatusResponseIngestionErrors']:
                return FeedsGetFeedStatusResponseIngestionErrors
            ...
            @staticmethod
            def itemDetails() -> typing.Type['FeedsGetFeedStatusResponseItemDetails']:
                return FeedsGetFeedStatusResponseItemDetails
            __annotations__ = {
                "errors": errors,
                "feedId": feedId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["errors"]) -> 'FeedsGetFeedStatusResponseErrors': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ingestionErrors"]) -> 'FeedsGetFeedStatusResponseIngestionErrors': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["itemDetails"]) -> 'FeedsGetFeedStatusResponseItemDetails': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["errors"]) -> typing.Union['FeedsGetFeedStatusResponseErrors', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ingestionErrors"]) -> typing.Union['FeedsGetFeedStatusResponseIngestionErrors', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["itemDetails"]) -> typing.Union['FeedsGetFeedStatusResponseItemDetails', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        errors: typing.Union['FeedsGetFeedStatusResponseErrors', schemas.Unset] = schemas.unset,
        ...
        ingestionErrors: typing.Union['FeedsGetFeedStatusResponseIngestionErrors', schemas.Unset] = schemas.unset,
        ...
        itemDetails: typing.Union['FeedsGetFeedStatusResponseItemDetails', schemas.Unset] = schemas.unset,
