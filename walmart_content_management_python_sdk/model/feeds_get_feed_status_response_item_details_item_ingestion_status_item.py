...
class FeedsGetFeedStatusResponseItemDetailsItemIngestionStatusItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ingestionErrors() -> typing.Type['FeedsGetFeedStatusResponseItemDetailsItemIngestionStatusItemIngestionErrors']:
                return FeedsGetFeedStatusResponseItemDetailsItemIngestionStatusItemIngestionErrors
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ingestionErrors"]) -> 'FeedsGetFeedStatusResponseItemDetailsItemIngestionStatusItemIngestionErrors': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ingestionErrors"]) -> typing.Union['FeedsGetFeedStatusResponseItemDetailsItemIngestionStatusItemIngestionErrors', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ingestionErrors: typing.Union['FeedsGetFeedStatusResponseItemDetailsItemIngestionStatusItemIngestionErrors', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'FeedsGetFeedStatusResponseItemDetailsItemIngestionStatusItem':
