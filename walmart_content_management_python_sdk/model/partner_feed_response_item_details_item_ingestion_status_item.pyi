...
class PartnerFeedResponseItemDetailsItemIngestionStatusItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ingestionErrors() -> typing.Type['PartnerFeedResponseItemDetailsItemIngestionStatusItemIngestionErrors']:
                return PartnerFeedResponseItemDetailsItemIngestionStatusItemIngestionErrors
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ingestionErrors"]) -> 'PartnerFeedResponseItemDetailsItemIngestionStatusItemIngestionErrors': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ingestionErrors"]) -> typing.Union['PartnerFeedResponseItemDetailsItemIngestionStatusItemIngestionErrors', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ingestionErrors: typing.Union['PartnerFeedResponseItemDetailsItemIngestionStatusItemIngestionErrors', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'PartnerFeedResponseItemDetailsItemIngestionStatusItem':
