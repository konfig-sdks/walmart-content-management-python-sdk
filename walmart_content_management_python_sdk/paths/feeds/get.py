...
from walmart_content_management_python_sdk.model.feeds_display_item_status_response import FeedsDisplayItemStatusResponse as FeedsDisplayItemStatusResponseSchema

from walmart_content_management_python_sdk.type.feeds_display_item_status_response import FeedsDisplayItemStatusResponse

from ...api_client import Dictionary
from walmart_content_management_python_sdk.pydantic.feeds_display_item_status_response import FeedsDisplayItemStatusResponse as FeedsDisplayItemStatusResponsePydantic
...
SchemaFor200ResponseBodyApplicationXml = FeedsDisplayItemStatusResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeedsDisplayItemStatusResponse
...
class BaseApi(api_client.Api):
    ...
    def _display_item_status_mapped_args(
        self,
        feed_id: str,
    ...
    async def _adisplay_item_status_oapg(
        self,
...
class DisplayItemStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adisplay_item_status(
        self,
        feed_id: str,
        wm_qos_correlation_id: str,
        wm_svc_name: str,
        ...
        **kwargs,
        ...
        args = self._display_item_status_mapped_args(
            feed_id=feed_id,
        ...
        return await self._adisplay_item_status_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def display_item_status(
        self,
        feed_id: str,
        wm_qos_correlation_id: str,
        wm_svc_name: str,
        ...
        return self._display_item_status_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class DisplayItemStatus(BaseApi):
    ...
    async def adisplay_item_status(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeedsDisplayItemStatusResponsePydantic:
        raw_response = await self.raw.adisplay_item_status(
            feed_id=feed_id,
            wm_qos_correlation_id=wm_qos_correlation_id,
            wm_svc_name=wm_svc_name,
            wm_sec_timestamp=wm_sec_timestamp,
        ...
        if validate:
            return FeedsDisplayItemStatusResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FeedsDisplayItemStatusResponsePydantic, raw_response.body)
    ...
    def display_item_status(
        ...
        raw_response = self.raw.display_item_status(
            feed_id=feed_id,
            wm_qos_correlation_id=wm_qos_correlation_id,
            wm_svc_name=wm_svc_name,
            wm_sec_timestamp=wm_sec_timestamp,
