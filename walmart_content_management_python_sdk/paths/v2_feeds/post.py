...
from walmart_content_management_python_sdk.model.feeds_create_rich_media_feed_response import FeedsCreateRichMediaFeedResponse as FeedsCreateRichMediaFeedResponseSchema

from walmart_content_management_python_sdk.type.feeds_create_rich_media_feed_response import FeedsCreateRichMediaFeedResponse

from ...api_client import Dictionary
from walmart_content_management_python_sdk.pydantic.feeds_create_rich_media_feed_response import FeedsCreateRichMediaFeedResponse as FeedsCreateRichMediaFeedResponsePydantic
...
# body param
SchemaForRequestBodyApplicationXml = schemas.StrSchema
...
SchemaFor200ResponseBodyApplicationXml = FeedsCreateRichMediaFeedResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: FeedsCreateRichMediaFeedResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_rich_media_feed_mapped_args(
        self,
        body: str,
        feed_type: str,
    ...
    async def _acreate_rich_media_feed_oapg(
        self,
    ...
    def _create_rich_media_feed_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
...
class CreateRichMediaFeedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_rich_media_feed(
        self,
        body: str,
        feed_type: str,
        wm_qos_correlation_id: str,
        ...
        **kwargs,
        ...
        args = self._create_rich_media_feed_mapped_args(
            body=body,
            feed_type=feed_type,
        ...
        return await self._acreate_rich_media_feed_oapg(
            body=args.body,
    ...
    def create_rich_media_feed(
        ...
        return self._create_rich_media_feed_oapg(
            body=args.body,
            query_params=args.query,
            header_params=args.header,
        )

class CreateRichMediaFeed(BaseApi):
    ...
    async def acreate_rich_media_feed(
        ...
        validate: bool = False,
        **kwargs,
    ) -> FeedsCreateRichMediaFeedResponsePydantic:
        raw_response = await self.raw.acreate_rich_media_feed(
            body=body,
            feed_type=feed_type,
            wm_qos_correlation_id=wm_qos_correlation_id,
            wm_svc_name=wm_svc_name,
        ...
        if validate:
            return FeedsCreateRichMediaFeedResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(FeedsCreateRichMediaFeedResponsePydantic, raw_response.body)
    ...
    def create_rich_media_feed(
        ...
        raw_response = self.raw.create_rich_media_feed(
            body=body,
            feed_type=feed_type,
            wm_qos_correlation_id=wm_qos_correlation_id,
            wm_svc_name=wm_svc_name,
