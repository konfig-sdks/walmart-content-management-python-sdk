...
from walmart_content_management_python_sdk.pydantic.feeds_display_item_status_response_errors_item_causes import FeedsDisplayItemStatusResponseErrorsItemCauses
from walmart_content_management_python_sdk.pydantic.feeds_display_item_status_response_errors_item_error_identifiers import FeedsDisplayItemStatusResponseErrorsItemErrorIdentifiers

class FeedsDisplayItemStatusResponseErrorsItem(BaseModel):
    ...
    causes: typing.Optional[FeedsDisplayItemStatusResponseErrorsItemCauses] = Field(None, alias='causes')

    error_identifiers: typing.Optional[FeedsDisplayItemStatusResponseErrorsItemErrorIdentifiers] = Field(None, alias='errorIdentifiers')
