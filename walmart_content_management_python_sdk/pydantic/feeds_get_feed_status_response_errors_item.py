...
from walmart_content_management_python_sdk.pydantic.feeds_get_feed_status_response_errors_item_causes import FeedsGetFeedStatusResponseErrorsItemCauses
from walmart_content_management_python_sdk.pydantic.feeds_get_feed_status_response_errors_item_error_identifiers import FeedsGetFeedStatusResponseErrorsItemErrorIdentifiers

class FeedsGetFeedStatusResponseErrorsItem(BaseModel):
    ...
    causes: typing.Optional[FeedsGetFeedStatusResponseErrorsItemCauses] = Field(None, alias='causes')

    error_identifiers: typing.Optional[FeedsGetFeedStatusResponseErrorsItemErrorIdentifiers] = Field(None, alias='errorIdentifiers')
