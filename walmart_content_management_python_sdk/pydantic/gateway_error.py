...
from walmart_content_management_python_sdk.pydantic.gateway_error_causes import GatewayErrorCauses
from walmart_content_management_python_sdk.pydantic.gateway_error_error_identifiers import GatewayErrorErrorIdentifiers
...
class GatewayError(BaseModel):
    ...
    causes: typing.Optional[GatewayErrorCauses] = Field(None, alias='causes')

    error_identifiers: typing.Optional[GatewayErrorErrorIdentifiers] = Field(None, alias='errorIdentifiers')
