...
from walmart_content_management_python_sdk.pydantic.partner_item_ingestion_status_ingestion_errors import PartnerItemIngestionStatusIngestionErrors

class PartnerItemIngestionStatus(BaseModel):
    ...
    ingestion_errors: typing.Optional[PartnerItemIngestionStatusIngestionErrors] = Field(None, alias='ingestionErrors')
    class Config:
