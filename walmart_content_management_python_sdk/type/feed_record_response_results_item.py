...
class RequiredFeedRecordResponseResultsItem(TypedDict):
    pass

class OptionalFeedRecordResponseResultsItem(TypedDict, total=False):
...
class FeedRecordResponseResultsItem(RequiredFeedRecordResponseResultsItem, OptionalFeedRecordResponseResultsItem):
    pass
