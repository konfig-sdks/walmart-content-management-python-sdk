...
from walmart_content_management_python_sdk.type.partner_item_ingestion_status_ingestion_errors import PartnerItemIngestionStatusIngestionErrors

class RequiredPartnerItemIngestionStatus(TypedDict):
    # Can be one of the following: DATA_ERROR, SYSTEM_ERROR, TIMEOUT_ERROR, or INPROGRESS
    ingestionStatus: str

class OptionalPartnerItemIngestionStatus(TypedDict, total=False):
    ...
    ingestionErrors: PartnerItemIngestionStatusIngestionErrors

class PartnerItemIngestionStatus(RequiredPartnerItemIngestionStatus, OptionalPartnerItemIngestionStatus):
    pass
